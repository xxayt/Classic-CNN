...
# 优化器
optimizer = optim.Adam(params=model.parameters(), lr=0.0002) # 学习率lr设为0.0002
# 更新步长
...
def save_model():
    ...
    if max_test_acc <= test_acc.avg:
        ...
        print("Best now is epoch={}, test acc={}.".format(epoch+1, max_test_acc))
        torch.save(model.state_dict(), model_path+"/model90.pkl")
        torch.save(optimizer.state_dict(), model_path+"/optimizer90.pkl")
